...
export const FETCH_PRODUCTS = `${DOMAIN}/api/products`;
export const FETCH_PRODUCT_BY_ID = `${DOMAIN}/api/product`;
...
export const MAKE_PURCHASE = `${DOMAIN}/api/purchase`;

export const FETCH_PURCHASE_HISTORY_BY_ID = `${DOMAIN}/api/purchase/history`;


//Admin
export const ADD_PRODUCT = `${DOMAIN}/api/products/store`;
